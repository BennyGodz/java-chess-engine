...
/**
 * Streams games from selected Lichess players and generates
 * Stockfish training positions.
 *
 * No Lichess database is downloaded.
 *
 * Pipeline:
 *
 * Lichess NDJSON game stream
 *        ↓
 * PGN moves
 *        ↓
 * Board positions
...
public class StockfishDataGenerator {
    ...
    private static final String STOCKFISH_PATH =
            "C:\\Users\\Benny\\stockfish\\stockfish.exe";
     ...
     */
    private static final int POSITION_COUNT =
            500_000;
     ...
     */
    private static final int STOCKFISH_DEPTH =
            16;
     ...
     */
    private static final int GAMES_PER_PLAYER =
            100;
     ...
     */
    private static final int MIN_PLIES =
            8;
     ...
     */
    private static final int POSITION_INTERVAL =
            2;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Starting Lichess → Stockfish training generation..."
        );
     ...
     */
    private static List<String> extractMoves(
            String pgn
    ) {
     ...
     *
     * This uses your existing Board legal move
     * generation rather than implementing chess
     * move legality again.
     */
    private static Move findMoveFromSAN(
            Board board,
            String san
    ) {
        ...
        switch (pieceLetter) {
            ...
            case 'N' ->
                    pieceClass =
                            chess.pieces.Knight.class;

            case 'B' ->
                    pieceClass =
                            chess.pieces.Bishop.class;

            case 'R' ->
                    pieceClass =
                            chess.pieces.Rook.class;

            case 'Q' ->
                    pieceClass =
                            chess.pieces.Queen.class;

            case 'K' ->
                    pieceClass =
                            chess.pieces.King.class;

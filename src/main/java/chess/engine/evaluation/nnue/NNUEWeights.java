...
public class NNUEWeights {
    ...
    public static NNUEWeights random() {
        ...
        double secondHiddenScale =
                Math.sqrt(
                        2.0 / SECOND_HIDDEN_SIZE
                );
        ...
        for (
                int h = 0;
                h < SECOND_HIDDEN_SIZE;
                h++
        ) {

            weights.secondHiddenBias[h] = 0.0;

            weights.outputWeights[h] =
                    random.nextGaussian()
                            * secondHiddenScale;
        }
     ...
     */
    public static NNUEWeights load(File file)
            throws IOException {
